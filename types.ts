...
export interface Plot {
  ...
  type: PlotType;
  isUnlocked: boolean;
  status: 'empty' | 'planted' | 'withered'; // Added 'withered'
  seedId?: string;
  daysPlanted: number;
  isWatered: boolean;
  isWithered: boolean;
...
// --- Image Proxy Helper to fix CORS errors ---
